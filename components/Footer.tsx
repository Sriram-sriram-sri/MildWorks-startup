...
const FooterLink = ({ children }: { children: React.ReactNode }) => (
    <a href="#" className="text-gray-500 hover:text-gray-900 transition-colors">{children}</a>
);
...
const SocialIcon = ({ children }: { children: React.ReactNode }) => (
     <a href="#" className="text-gray-400 hover:text-gray-800 transition-colors">{children}</a>
);

export const Footer = () => {
    const columns = {
        'Apps and Extensions': ['Mobile Apps', 'Desktop Apps', 'Developer Center', 'Google Workspace Integration', 'Microsoft 365 Integration', 'Apps for Apple Watch', 'Product Integrations'],
        'Learn': ['Training and Certification', 'Academy', 'Blog', 'Knowledge Base', 'Product Alternatives', 'Milo', 'The Long Game', 'Newsletter'],
        'Community': ['User Community', 'Customer Stories', 'Work With a Partner', 'Mild Works for Startups', 'Affiliate Program', 'Humans of Mild Works'],
        'Company': ['About Us', 'Our Story', 'Press', 'Events', 'Branding Assets', 'Mild Works Schools', 'Service Status', 'Careers'],
        'Contact Sales': ['Phone', '1800.103.1123', '1800.572.3535', 'Email', 'sales@mildworkscorp.com', 'Support >', 'Talk to Concierge >']
    };
        ...
        <footer className="bg-gray-50">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
                ...
                <div className="mt-12 border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 mt-8 md:mt-0 text-sm text-gray-500">
                        <FooterLink>Mild Works Home</FooterLink>
